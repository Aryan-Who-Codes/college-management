...
//   return (
//     <div className="bg-gradient-to-br from-white to-rose-50/30 rounded-xl sm:rounded-2xl w-full h-full p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-rose-100/40 relative overflow-hidden">
//       {/* BACKGROUND DECORATION */}
//       <div className="absolute top-0 right-0 w-24 h-24 bg-rose-200/10 rounded-full -translate-y-8 translate-x-8"></div>
//       <div className="absolute bottom-0 left-0 w-20 h-20 bg-rose-300/10 rounded-full translate-y-6 -translate-x-6"></div>
...
//           <div className="w-4 h-4 sm:w-5 sm:h-5 bg-amber-600 rounded-sm opacity-70 hover:opacity-100 transition-opacity"></div>
//         </div>
//       </div>
...
//     return (
//         <div className="bg-gradient-to-br from-white to-indigo-50/30 rounded-xl sm:rounded-2xl w-full h-full p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-indigo-100/40 relative overflow-hidden">
//             {/* BACKGROUND DECORATION */}
