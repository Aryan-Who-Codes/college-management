...
const StudentListPage = () => {
  const renderRow = (item: Student) => (
    ...
    >
      ...
      <td className="hidden md:table-cell p-2 sm:p-4 text-xs sm:text-sm">{item.studentId}</td>
      <td className="hidden md:table-cell p-2 sm:p-4 text-xs sm:text-sm">{item.grade}</td>
