    ...
    const renderRow = (item: Class) => (
        ...
        >
            <td className="flex items-center gap-2 sm:gap-4 p-2 sm:p-4 min-w-0">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br from-indigo-400 to-purple-500 flex items-center justify-center text-white font-bold text-xs sm:text-sm flex-shrink-0">
                    {item.grade}
                </div>
                <div className="flex flex-col min-w-0 flex-1">
                    ...
                    <p className="text-xs text-gray-500 truncate md:hidden">
                        {item.capacity} students • {item.supervisor}
                    </p>
                </div>
            </td>
            ...
            <td className="hidden md:table-cell p-2 sm:p-4 text-xs sm:text-sm max-w-[120px] lg:max-w-none">
                <div className="truncate" title={item.supervisor}>
                    {item.supervisor}
                </div>
            </td>
